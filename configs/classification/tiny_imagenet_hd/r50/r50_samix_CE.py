_base_ = [
    "../../_base_/datasets/tiny_imagenet_hd/sz224_randaug_bs256.py",
...
conv1x1=dict(
    type="ConvNeck",
    in_channels=1024, hid_channels=256, out_channels=1,
...
model = dict(
    ...
    backbone=dict(
        ...
        depth=50,
        num_stages=4,
        out_indices=(2, 3),  # 2:[b,512,28,28], 3:[b,1024,14,14]
        style='pytorch'),
    mix_block=dict(
        type='PixelMixBlock',
        ...
        lam_mul=True, lam_residual=True, lam_mul_k=-1,
...
# learning policy
lr_config = dict(
    policy='CosineAnnealing', min_lr=0.0)
