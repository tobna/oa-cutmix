...
# model settings — finetune from DeiT III Small ImageNet-1k pretrained
model = dict(
    type="MixUpClassification",
    pretrained=(
        "https://dl.fbaipublicfiles.com/deit/deit_3_small_224_1k.pth"
    ),
    alpha=[1, 0.8],
...
# optimizer — keep lr=5e-5; bs doubled to 32 halves the per-sample lr
optimizer = dict(
    type="AdamW",
    lr=5e-5,
    weight_decay=0.05,
