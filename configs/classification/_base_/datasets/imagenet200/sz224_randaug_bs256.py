# configs/classification/_base_/datasets/imagenet200/sz224_randaug_bs256.py
# ImageNet200: full ImageNet filtered to the 200 TinyImageNetHD classes.
# Requires data/meta/ImageNet200/classes.txt (generate with
# tools/prepare_data/create_imagenet200_classes.py).
...
train_pipeline = [
    dict(type="RandomResizedCropPair", size=224, scale=[0.08, 1], interpolation=3),  # bicubic
