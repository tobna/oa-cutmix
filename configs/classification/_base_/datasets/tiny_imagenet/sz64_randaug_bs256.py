# configs/classification/_base_/datasets/tiny_imagenet_hd/sz64_bs256.py
...
train_pipeline = [
    dict(type="RandomResizedCropPair", size=64, scale=[0.8, 1], interpolation=3),
...
test_pipeline = [
    dict(type="Resize", size=64, interpolation=3),
...
data = dict(
    imgs_per_gpu=256,  # 256 x 1gpu = 256
    workers_per_gpu=20,
    train=dict(
        type=dataset_type,
