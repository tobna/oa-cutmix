...
data = dict(
    imgs_per_gpu=1024,  # V100/A100: 256 x 1gpus x 1 accumulate = bs1024
...
# validation hook
evaluation = dict(initial=False, interval=1, imgs_per_gpu=256, workers_per_gpu=6, eval_param=dict(topk=(1, 5)))
