...
@torch.no_grad()
def cutmix_stupid(img, gt_label, alpha=1.0, lam=None, dist_mode=False, return_mask=False, stupidity=1.0, **kwargs):
    ...
    if not dist_mode:
        ...
        return img, (y_a, y_b, lam * (1.0 - stupidity) + stupidity / 2.0)
    ...
    # dist mixup with cross gpus shuffle
        ...
        if gt_label is not None:
            ...
            return img, (idx_shuffle, idx_unshuffle, lam * (1.0 - stupidity + stupidity / 2.0))
